          ...
          <div className="features-grid">
            <div className="feature-card">
              <div className="feature-icon">
                <img src="/assets/icon/convert.gif" alt="" className="feature-icon-img" />
              </div>
            ...
            <div className="feature-card">
              <div className="feature-icon">
                <img src="/assets/icon/resize.gif" alt="" className="feature-icon-img" />
              </div>
            ...
            <div className="feature-card">
              <div className="feature-icon">
                <img src="/assets/icon/crop.gif" alt="" className="feature-icon-img" />
              </div>
